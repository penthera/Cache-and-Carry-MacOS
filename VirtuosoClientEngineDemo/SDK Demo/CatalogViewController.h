...
/*
 * Provides a basic list of catalog items for the purposes of this demo.  Demonstrates how to create
 * and start a download.
 */
@interface CatalogViewController : NSViewController<NSCollectionViewDelegate,NSCollectionViewDataSource>
