...
/*
 * The logging preferences pane demonstrates how to configure logging in the SDK.
 */
@interface LoggingPreferencesViewController : NSViewController

@property (nonatomic,assign) Boolean logBackplaneComms;
@property (nonatomic,assign) Boolean logHTTPProxyComms;

@property (nonatomic,strong) IBOutlet NSPopUpButton* logLevel;
@property (nonatomic,strong) VirtuosoLogger* logger;

- (IBAction)loggingForEventUpdated:(id)sender;
