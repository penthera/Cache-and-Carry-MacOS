...
/*
 * The storage preferences pane demonstrates how to configure the storage related
 * settings in the SDK.
 */
@interface StoragePreferencesViewController : NSViewController

@property (nonatomic,strong) NSString* storageHeadroom;
@property (nonatomic,strong) NSString* allowableStorage;
